...
public class DB_Controller {
    ...
    private static final String SQL_GET_CATEGORY_COLOR = "select * from categories where id = ?";
    private static final String SQL_GET_CATEGORY_NAME = "select * from categories where id = ?";
    private static final String SQL_GET_CATEGORY_ID = "select * from categories where name = ?";
    ...
    private static final String SQL_UPDATE_CHECK_PRIMARY = "update checks set categoryPrimaryId = ? where id = ?";
    ...
    public static ArrayList<Check> loadChecks() throws SQLException {
        ...
        while (checks.next()){
            ...
            for(Integer id: ids)
                categories.add(new Category(getName(id),getColor(id)));
            result.add(new Check(categories,
                                 new Category(getName(checks.getInt("categoryPrimaryId")),getColor(checks.getInt("categoryPrimaryId"))),
    ...
    public static String getColor(int id) throws SQLException {
